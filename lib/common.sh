...
function help(){
    ...
    echo ""
    echo "Commands:"
    echo -e $GREEN'create'$COLOR_END    "   Create a new Node. The node hosts Quorum, Tessera and Node Manager"
    ...
    echo "  --aa, --autoaccept      Auto Accept Join Request (Optional)"
    echo ""
    echo "E.g."
    ...
    echo "  --pk                    Public Key of existing Tessera"
    echo "  -r, --rpc               RPC port of the existing Quorum"   
    echo "  -w, --whisper           Discovery port of this node" 
    echo "  -t, --tessera           Tessera port existing node"
    ...
    echo ""
    echo "E.g."
    echo "./setup.sh attach -n slave1 --ip 10.0.2.15 --pk BULeR8JyUWhiuuCMU/HLA0Q5pzkYT+cHII3ZKBey3Bo= -r 22000 --whisper 21000 --tessera 9001 --raft 50401 --nm 11004 --active"
    echo ""
